...
monedas_disponibles = ["BTC", "EUR", "ETH", "XRP", "SOL"]
...
class MovementForm(FlaskForm):
    ...
    moneda_from = SelectField("From",choices=[
        ("EUR", "EUR"), ("BTC", "BTC"), ("ETH", "ETH"), ("XRP", "XRP"), ("SOL", "SOL")], validators=[DataRequired()])
    moneda_to = SelectField("To", choices=[
        ("EUR", "EUR"), ("BTC", "BTC"), ("ETH", "ETH"), ("XRP", "XRP"), ("SOL", "SOL")], validators=[DataRequired(), validar_moneda])
